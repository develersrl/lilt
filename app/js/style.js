...
const blocks = {
  ...
  tabbar: {
    ...
    pathUnselectedIcon: require('../images/bar-path-1.png'),
    pathSelectedIcon: require('../images/bar-path-2.png'),
...
const pages = {
  ...
  home: {
    ...
    menuTopLeftIcon: require('../images/transparent.png'),
    menuTopRightBackground: '#C1DBF8',
    menuTopRightIcon: require('../images/transparent.png'),
    menuBottomLeftBackground: '#74B3FA',
    menuBottomLeftIcon: require('../images/transparent.png'),
    menuBottomRightBackground: '#FF9C8D',
    menuBottomRightIcon: require('../images/transparent.png'),
    customMenuCircleWidth: 40,
    customMenu1Background: '#FF9C8D',
    customMenu1Icon: require('../images/transparent.png'),
    customMenu2Background: '#74B3FA',
    customMenu2Icon: require('../images/transparent.png'),
    customMenu3Background: '#C1DBF8',
    customMenu3Icon: require('../images/transparent.png'),
    customMenu4Background: '#FFE0D0',
    customMenu4Icon: require('../images/transparent.png'),
    customMenuIconTextGap: 15,
    customMenuTextMargins: 5,
    customMenuTextFontSize: 11,
    customMenuLeftRightMargins: 20,
  },
  question: {
    backgroundColor: '#C1DBF8',
    bodyPadding: 30,
